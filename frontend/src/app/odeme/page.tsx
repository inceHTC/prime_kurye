...
import { ArrowLeft, Loader2, Lock, Shield, Zap } from 'lucide-react'
...
function PaymentContent() {
  ...
  }, [order, checkoutForm, isInitializing])
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#faf9f7', fontFamily: "'Barlow', sans-serif" }}>
      ...
      <main style={{ maxWidth: 680, margin: '0 auto', padding: '32px 20px 80px' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1c0800', marginBottom: 24 }}>Ödeme</h1>

        {order && (
          <div style={{ background: '#fff', borderRadius: 12, border: '1px solid rgba(28,8,0,0.08)', padding: '20px 22px', marginBottom: 24 }}>
            <h2 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#1c0800', marginBottom: 16 }}>Sipariş Özeti</h2>
