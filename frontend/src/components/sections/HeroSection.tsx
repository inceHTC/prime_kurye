  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
          ...
          <div style={{ maxWidth: 620 }}>
            ...
            <div className="animate-fade-up" style={{
              ...
              <span style={{
                ...
                color: '#c8860a', letterSpacing: '0.08em',
            ...
            <p className="animate-fade-up delay-200" style={{
              ...
              Bireysel ve kurumsal profesyonel motokurye hizmeti. <br />
              Kapıdan kapıya 60–90 dakika, gerçek zamanlı takip,
              %99.9 teslimat başarısı.
            </p>
            ...
            <div className="animate-fade-up delay-400" style={{
              ...
              <input
                ...
                style={{
                  ...
                  padding: '11px 16px', color: '#fff', outline: 'none',
                  fontFamily: "'Barlow', sans-serif", fontSize: '0.875rem',
                }}
                onKeyDown={e => {
                  if (e.key === 'Enter' && trackCode.trim()) {
                    window.location.href = `/takip/${trackCode.trim()}`
                  }
                }}
              />
              <Link
                href={trackCode.trim() ? `/takip/${trackCode.trim()}` : '/takip'}
                style={{
        ...
        {/* Sağ — istatistik kutuları (desktop) */}
        <div className="hidden lg:flex" style={{
          ...
          {[
            ...
            { value: '30.000₺ ', label: 'Paket Güvencesi' },
          ].map(stat => (
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            ...
            { icon: '🛡️', title: '30.000₺ Güvence', desc: 'Paket sigortası' },
            { icon: '🏍️', title: 'Motokurye', desc: 'Kapıdan kapıya' },
          ].map((item, i) => (
            <div key={item.title} style={{
              padding: '20px 24px',
              display: 'flex', alignItems: 'center', gap: 14,
              borderRight: i < 3 ? '1px solid rgba(28,8,0,0.15)' : 'none',
            }}>
              ...
              <div>
                ...
                <div style={{
                  fontFamily: "'Barlow', sans-serif",
                  fontSize: '0.8rem', color: 'rgba(28,8,0,0.65)',
                  fontWeight: 500,
                }}>
                  {item.desc}
                </div>
