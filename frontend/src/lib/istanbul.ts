...
export const ISTANBUL_DISTRICTS: DistrictOption[] = [
  ...
  { value: 'arnavutkoy', label: 'Arnavutköy', lat: 41.1856, lng: 28.7407 },
  { value: 'atasehir', label: 'Ataşehir', lat: 40.9833, lng: 29.1167 },
  { value: 'avcilar', label: 'Avcılar', lat: 40.9799, lng: 28.7214 },
  { value: 'bagcilar', label: 'Bağcılar', lat: 41.039, lng: 28.8567 },
  { value: 'bahcelievler', label: 'Bahçelievler', lat: 41.0064, lng: 28.8406 },
  { value: 'bakirkoy', label: 'Bakırköy', lat: 40.9809, lng: 28.8753 },
  { value: 'basaksehir', label: 'Başakşehir', lat: 41.0931, lng: 28.8025 },
  { value: 'bayrampasa', label: 'Bayrampaşa', lat: 41.0482, lng: 28.9004 },
  { value: 'besiktas', label: 'Beşiktaş', lat: 41.043, lng: 29.0094 },
  { value: 'beykoz', label: 'Beykoz', lat: 41.1342, lng: 29.0927 },
  { value: 'beylikduzu', label: 'Beylikdüzü', lat: 41.0015, lng: 28.6417 },
  { value: 'beyoglu', label: 'Beyoğlu', lat: 41.037, lng: 28.985 },
  { value: 'buyukcekmece', label: 'Büyükçekmece', lat: 41.0218, lng: 28.585 },
  { value: 'catalca', label: 'Çatalca', lat: 41.1426, lng: 28.4619 },
  { value: 'cekmekoy', label: 'Çekmeköy', lat: 41.0331, lng: 29.1756 },
  { value: 'esenler', label: 'Esenler', lat: 41.0432, lng: 28.8738 },
  { value: 'esenyurt', label: 'Esenyurt', lat: 41.0343, lng: 28.6801 },
  { value: 'eyupsultan', label: 'Eyüpsultan', lat: 41.0822, lng: 28.9336 },
  { value: 'fatih', label: 'Fatih', lat: 41.017, lng: 28.9497 },
  { value: 'gaziosmanpasa', label: 'Gaziosmanpaşa', lat: 41.0742, lng: 28.9106 },
  { value: 'gungoren', label: 'Güngören', lat: 41.0178, lng: 28.8726 },
  { value: 'kadikoy', label: 'Kadıköy', lat: 40.9919, lng: 29.0277 },
  { value: 'kagithane', label: 'Kağıthane', lat: 41.0852, lng: 28.967 },
  { value: 'kartal', label: 'Kartal', lat: 40.8889, lng: 29.1856 },
  { value: 'kucukcekmece', label: 'Küçükçekmece', lat: 41.0006, lng: 28.7897 },
  ...
  { value: 'sariyer', label: 'Sarıyer', lat: 41.1669, lng: 29.051 },
  ...
  { value: 'sisli', label: 'Şişli', lat: 41.0605, lng: 28.9872 },
  { value: 'tuzla', label: 'Tuzla', lat: 40.8167, lng: 29.3003 },
  { value: 'umraniye', label: 'Ümraniye', lat: 41.0164, lng: 29.1248 },
  { value: 'uskudar', label: 'Üsküdar', lat: 41.0236, lng: 29.0152 },
